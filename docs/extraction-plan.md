...
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Package name       | **Decided: `kidesia-ui`** (unscoped, kept from the previous attempt)                                                                                                                                                                                                     |                                                                                                                                                        |
...
| Distribution       | **Decided: public npm** (`kidesia-ui`), published by the tag-triggered Release workflow with provenance                                                                                                                                                                  |                                                                                                                                                        |
...
1. ~~Package name/scope and registry~~ — decided: public npm as `kidesia-ui`.
